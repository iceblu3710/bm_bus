...
# This dictionary is the starting point for mapping G-code commands to the
# low-level bus packets they generate. As analysis continues, this can be
# populated with specific packet types (ptype), payload structures, and meanings.
GCODE_MAP = {
    "M73": {
        "description": "Set/Get Build Percentage. Used as a 'magic packet' for synchronization.",
        "packet_flow": "AP -> MC",
        "ptype": "TBD",
        "payload_format": "TBD (likely contains percentage and time values)"
    },
    "G0/G1": {
        "description": "Linear Move. The main processor translates this into a high-frequency polling loop.",
        "packet_flow": "MC <-> TH",
        "ptype": "TBD (likely multiple types for request/response)",
        "payload_format": "TBD (requests for status, responses with position/sensor data)"
    },
    "M104/M109": {
        "description": "Set Hotend Temperature. M109 waits for the temperature to be reached.",
        "packet_flow": "AP -> MC -> TH",
        "ptype": "TBD (for both setting and reporting temperature)",
        "payload_format": "TBD (likely contains target temperature and reports current temperature)"
    },
    "M106": {
        "description": "Set Fan Speed.",
        "packet_flow": "AP -> MC -> TH",
        "ptype": "TBD",
        "payload_format": "TBD (likely contains fan index and speed value)"
    }
}
