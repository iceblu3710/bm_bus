...
; model printing time: 0.903531s; total estimated time: 5s
...
; machine_start_gcode = ; Set units to millimeters\nG21\n\n; Set to absolute positioning\nG90\n\n; --- Heat bed and nozzle to a stable, low temperature ---\nM140 S60  ; Set bed temperature to 60C (no wait)\nM104 S140 ; Set nozzle temperature to 140C (no wait)\nM190 S60  ; Wait for bed to reach 60C\nM109 S140 ; Wait for nozzle to reach 140C\n\n; --- Home the printer to establish a known coordinate system ---\n; This is the most critical step for reliable movement tests.\nG28 ; Home all axes (X, Y, and Z)\n\n; Set extruder to relative mode to prevent runaway extrusion if E commands are tested\nM83\n\n; --- YOUR TEST G-CODE (e.g., G1 X0.01 F600) GOES HERE ---\n; G-code for fingerprinting Bambu-Bus movement commands.\n; Each block is designed to isolate a specific variable.\n; Use M73 progress markers to correlate G-code with bus capture timestamps.\n\n; --- BLOCK A: G1 Linear Move - Varying DISTANCE, Fixed Feedrate ---\n; This block will show how the distance value is encoded.\nG91 ; Set to relative positioning for incremental moves\nM73 P1 ; Block A1\nG1 X1 F3000\nM400\nM73 P2 ; Block A2\nG1 X10 F3000\nM400\nM73 P3 ; Block A3\nG1 X50 F3000\nM400\nM73 P4 ; Block A4 - Negative direction\nG1 X-10 F3000\nM400\nG90 ; Return to absolute positioning\nG1 X128 Y128 F18000 ; Return to center\n\n; --- BLOCK B: G1 Linear Move - Fixed Distance, Varying FEEDRATE ---\n; This block will show how the feedrate (velocity) value is encoded.\nG91 ; Set to relative positioning\nM73 P10 ; Block B1\nG1 X10 F600\nM400\nM73 P11 ; Block B2\nG1 X10 F6000\nM400\nM73 P12 ; Block B3\nG1 X10 F18000\nM400\nG90 ; Return to absolute positioning\nG1 X128 Y128 F18000 ; Return to center\n\n; --- BLOCK C: G0 Rapid Move - Varying DISTANCE ---\n; This block will identify the G0 command packet and how its distance is encoded.\n; G0 moves use the machine's maximum feedrate.\nG91 ; Set to relative positioning\nM73 P20 ; Block C1\nG0 X10\nM400\nM73 P21 ; Block C2\nG0 X50\nM400\nG90 ; Return to absolute positioning\nG1 X128 Y128 F18000 ; Return to center\n\n; --- BLOCK D: Combined Axis Movement ---\n; This block will show how multiple axes are encoded in the bitmask.\nG91 ; Set to relative positioning\nM73 P30 ; Block D1\nG1 X10 Y10 F6000\nM400\nG90 ; Return to absolute positioning\nG1 X128 Y128 F18000 ; Return to center\n\nM73 P100 ; End of test sequence\n
